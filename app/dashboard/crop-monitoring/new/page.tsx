        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => setFormData({ ...formData, ndvi_value: e.target.value })}
                placeholder="0.75"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => setFormData({ ...formData, evi_value: e.target.value })}
                placeholder="0.65"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => setFormData({ ...formData, ndwi_value: e.target.value })}
                placeholder="0.45"
              />
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => setFormData({ ...formData, satellite_image_url: e.target.value })}
